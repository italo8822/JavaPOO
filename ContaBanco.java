...
public class ContaBanco {
    ...
    public void abrirConta(String t) {
        ...
        if ("CC".equals(t)) {                // (t == "CC") ContaCorrente
            this.setSaldo(50);
        } else if ("CP".equals(t)) {        // (t == "CP") ContaPolpança
            this.setSaldo(150);
        }
    ...
    public void depositar(float v) {
        if (this.getStatus()) {
            //this.saldo = this.saldo + v;            //diretamente com atributos
            this.setSaldo(this.getSaldo() + v);       //diretamente com metodos especiais 
